...
- **No account required.** You can use Chatura without registering.
...
Chatura stores the following **only on your device**:
...
Chatura relies on third-party service providers to operate the app and deliver AI features.
...
Chatura is **not intended for individuals under 18**, and we do not knowingly collect information from individuals under 18.
